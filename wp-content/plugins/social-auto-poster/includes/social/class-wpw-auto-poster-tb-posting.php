...
class Wpw_Auto_Poster_TB_Posting {
    ...
    public function wpw_auto_poster_tb_user_logged_in() {
        ...
        if ( isset($_GET['auth']) && $_GET['auth'] == 'tumbauth' 
            ...
            $wpw_auto_poster_account_info = $wpw_auto_poster_tumb_oauth->get(esc_url_raw($wpw_auto_poster_tumb_oauth->getUserInfoAuthentication()) );
                ...
                foreach ( $post_to_users as $post_to ) {
                    ...
                    try {   
                        ...
                        if( isset($wpw_auto_poster_tb_sess_data[$tb_app_id]) ) {
                            ...
                            $postinfo = $wpw_auto_poster_tumb_oauth->post( esc_url_raw($wpw_auto_poster_tumb_oauth->getPostingInfoUrl().$wpw_auto_poster_account_url.'/post'), $tumblrdata ); 
